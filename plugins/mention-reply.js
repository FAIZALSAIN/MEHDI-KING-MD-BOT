    ...
    if (m.mentionedJid.includes(botNumber)) {
      ...
      await conn.sendMessage(m.chat, {
        ...
        contextInfo: {
          ...
          isForwarded: true,
          externalAdReply: {
            title: config.BOT_NAME || "𝐌𝐄𝐇𝐃𝐈-𝐌𝐃  🥀",
            body: config.DESCRIPTION || "𝐌𝐄𝐇𝐃𝐈-𝐌𝐃 🤌💗",
            mediaType: 1,
            renderLargerThumbnail: true,
            thumbnail: thumbnailBuffer,
            mediaUrl: "https://files.catbox.moe/8c4lpm.jpg", // Static image URL
            sourceUrl: "https://api.whatsapp.com/send?phone=923345254558&text=FAMOUS-MEHDI-KING-SAVE-DONE°³👨🏻‍💻☠️🚩",
